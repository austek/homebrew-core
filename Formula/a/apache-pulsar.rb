class ApachePulsar < Formula
  ...
  url "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=pulsar/pulsar-3.2.0/apache-pulsar-3.2.0-src.tar.gz"
  mirror "https://archive.apache.org/dist/pulsar/pulsar-3.2.0/apache-pulsar-3.2.0-src.tar.gz"
  sha256 "e911b32fc80e51574f569e214379f8b6b8a8e7f6a2955bbf1a684ee1c7c5e401"
  license "Apache-2.0"
